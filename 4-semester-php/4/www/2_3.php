<?php
$isLoginCompleted = isset($_POST['2_action']) && $_POST['2_action'] == 'Login';
...
if ($isLoginCompleted) {
    if ($_POST['2_password'] == 'superpass') { // md5 should be here
        session_start();
        ...
        $loginCount++;
        setcookie('loginCount', $loginCount, time() + (86400 * 30), "/");
    }
}
...
{
    echo 'Login: <input type="text" name="2_login" /> <br />
    Password: <input type="password" name="2_password" /> <br />
    <input type="submit" name="2_action" value="Login" />
        ';
}
...
';
    ...
    if (isset($_SESSION['isLoggedIn']) && $_SESSION['isLoggedIn']) {
        echo 'Login count: ' . $loginCount . '<br/>';
        echo 'People:
